...
<body>
    ...
    $result = $mysqli->query("SELECT b.bestellungID, k.name AS kundenname, gg.gekochtesgerichtID, b.zeitpunkt, b.preis, b.zahlungsart FROM Bestellung b JOIN Kunde k ON b.kundeID = k.kundeld JOIN GekochtesGericht gg ON b.gekochtesgerichtID = gg.gekochtesgerichtID");
